...
<!--            >Hi I'm Cynthia Price,has been the industry's standard dummy text To an English person, it will seem like simplified English, as a skeptical Cambridge.</p>-->
            <div class="table-responsive ">
              <table class="table table-nowrap mb-0">
                <tbody>
                <tr>
                  <th scope="row" class="fw-normal" style="background-color: #b50027 !important;">Tên tài khoản :</th>
                  <td class="fw-bold">{{modelView.userName}}</td>
                </tr>
                <tr>
                  <th scope="row" class="fw-normal" style="background-color: #b50027 !important;">Họ và tên :</th>
                  <td class="fw-bold" style="background-color: #fff !important;">{{modelView.fullName}}</td>
                </tr>
                <tr>
                  <th scope="row" class="fw-normal" style="background-color: #b50027 !important;">E-mail :</th>
                  <td class="fw-bold">{{modelView.email}}</td>
                </tr>
                <tr>
                  <th scope="row" class="fw-normal" style="background-color: #b50027 !important;">Số điện thoại :</th>
