<template>
    <div class="vue-booklet">
      <div class="select-page-wrapper" v-show="enableSelectPage && enableControl" style="display: none !important;">
        <label for="select-page">{{translateText.selectPage}}: </label>
        <select id="select-page" v-on:change="selectPage">
          <option v-for="(pageNumber, index) in totolPages" :ref="'page' + pageNumber" :value="pageNumber" :key="index">
            {{pageNumber}}
          </option>
        </select>
      </div>
      <div class="select-page-wrapper-mobile" v-show="enableSelectPage && enableControl">
        ...
        <select id="select-page-mobile" v-on:change="selectPageMobile">
          <option v-for="(pageNumber, index) in totolPages" :value="pageNumber" :key="index">
            {{pageNumber}}
          </option>
        </select>
      </div>
