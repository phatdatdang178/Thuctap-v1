          ...
          <div class="wrap-main">
            <div class="row">
              <div class="col-lg-12">
                  <section>
                    <div class="row">
                      <div class="col-lg-4 col-md-6 col-sm-6" v-for="(item, index) in hoa"
                            :key="index">
                        <div
                            class="row"
                        >
                          <div class="col-md-12 mb-4" style="position: relative;">
                                    ...
                                    <div v-if="!item.avatar">
                                      <div class="float-left">
                                        <img
                                            ...
                                            alt="Không có ảnh"
                                            class="w-100"
                                            style="height: 300px; padding: 10px; border-top-right-radius: 5px !important; border-top-left-radius: 5px !important;"
                                        >
                                      </div>
                                    </div>
                                    <div v-else>
                                        <b-card-img
                                            ...
                                            class="img-hoa"
                                            style="height: 300px; border-top-right-radius: 5px !important; border-top-left-radius: 5px !important;"
                                        ></b-card-img>
                                    </div>
                                  </router-link>
                                  <b-card-img
                                      ...
                                      class="img-qrcode"
                                      style="position: absolute; top: 0; width: 20%; opacity: 0.7; border-bottom-right-radius: 5px !important; "
                                  ></b-card-img>
                                </b-col>
                            ...
                            <div class="view" style="position: absolute; right: 30px; bottom: 10px;">
                              <i class="mdi mdi-eye"><span style="margin-left: 10px;">{{ item.view }}</span></i>
                            </div>
                          </div>
                        </div>
                      </div>
